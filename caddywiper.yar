...
rule Caddy {
    ...
    strings:
        ...
        $s3 = { 44 73 52 6F 6C 65 47 65 74 50 72 69 6D 61 72 79 44 6F 6D 61 69 6E 49 6E 66 6F 72 6D 61 74 69 6F 6E // "DsRoleGetPrimaryDomainInformation"
                [1-4]
                4E 45 54 41 50 49 33 32 2E 64 6C 6C /* "NETAPI32.dll" */ }
        ...
        */
        $s4 = { 6B C6 45 ?? 00 C6 45 ?? /* 'k' */
                ...
                6c C6 45 ?? 00 C6 45 ?? /* 'l' */ }
    condition:
        (1 of them) and Caddy_file_length and Caddy_file_size
}
